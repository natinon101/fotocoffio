...
<head>
    ...
    <style>
        <?php include('style.css') ?><?php include('styleaboutus.css') ?>
    </style>
...
<body>
    ...
    <div class="BGdrinkmenu">
        ...
        <div class="drink">
            <h1>เกี่ยวกับ FOTO COFFIO</h1>
        </div>

        <div class="about">
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;FOTO&nbsp;
                COFIO&nbsp;เป็นร้านกาแฟที่ไม่นำแฟนไชส์ของเจ้าใดมาใช้เป็นร้านที่จดลิขสิทธิ์เรียบร้อบแล้ว
                โดยมีการนำเมล็ดกาแฟจากหลากหลายแหล่งที่มา&nbsp;มาผสมในปริมาณที่พอตัวเพื่อให้เมล็ด
                กาแฟคัดสรรคุณภาพจากโรงงานและยังคงความสดใหม่ของเมล็ดกาแฟเสมอ&nbsp;เพื่อคงรสชาติ
                และกลิ่นให้ยังหอมมันเป็นกาแฟที่เรายินดีภูมิใจเสนอในทุกวันนี้
            </p>
...
<!-- คั่นนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนนน -->
